export const projects = [
    {
        ...
        keywords: ["generative AI", "future of work", "data mining"],
        paragraph: `In this project, we are investigating behavioral shifts within the online community, Stack Overflow, seeking insights into the future of work by identifying which contributors adapt and thrive in the evolving landscape of AI and which gradually disengage. We want to find out how the introduction of generative AI, specifically ChatGPT, impacts the engagement patterns of different contributor groups on Stack Overflow. To this end, we are clustering 1,277,423 users on Stack Overflow based on their behaviors and seeing if each cluster has distinct usage patterns before and after the ChatGPT release. We use graph-based clustering and topic modeling approach — a seeded Latent Dirichlet Allocation (LDA) — to cluster users.`,
    },
    {
        id: "story",
        topic: ["research"],
    ...
    },
    {
        ...
        title: "Noteworthy",
        year: 202208,
        desc: "Leveraging Generative AI to Support the Note-Taking Process",
        ...
        current: true,
        paragraph: `Taking notes is an important aspect of learning that can enhance memory retention, organization, and clarification. However, note-taking can be demanding and sometimes results in incomplete or unclear notes. Recent advances in generative AI have sought to address these challenges by augmenting the note-taking process, yet there is a gap in the literature regarding the evaluation and comparison of different AI-assisted note-taking methods. In this paper, we introduce Noteworthy, a note-taking tool powered by GPT-4 that provides autocomplete text suggestions in real time. We conducted a controlled experiment with 30 participants, comparing traditional note-taking (human only), fully automated AI-generated notes (AI only), and a hybrid approach using Noteworthy (human-AI combination). Our findings highlight the significance of the level of control allocated to the AI and reveal how different note-taking approaches correlate with learning outcomes, efficiency, and task load.`,
    },
    {
        id: "minglr",
        topic: ["research"],
    ...
    },
    {
        ...
        keywords: ["service design", "visualization"],
    ...
    },
    {
        ...
        year: 201805,
        topic: ["schoolwork"],
        keywords: ["visualization", "data mining"],
