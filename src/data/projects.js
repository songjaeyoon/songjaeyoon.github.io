export const projects = [
    ...
    },
    {
        ...
        current: true,
        paragraph: `Note-taking is essential for learning, yet it poses challenges such as filtering key information and organizing content in real time. Recent advances in AI have sought to address these challenges by automating aspects of the note-taking process. However, there remains a gap in the literature regarding the evaluation and comparison of different AI-assisted note-taking methods. In this paper, we introduce Noteworthy, a note-taking system that leverages large language models to provide real-time autocomplete suggestions. We conducted a controlled experiment with 30 participants, comparing three conditions: traditional note-taking (human only), fully automated AI-generated notes (AI only), and a hybrid approach using Noteworthy (human-AI collaboration). Our results show that with Noteworthy, participants experienced less frustration and generated longer notes with lower physical load. However, these efficiency gains came at the cost of reduced learning outcomes compared to traditional note-taking. These findings suggest that AI-assisted features may unintentionally hinder learning by making the process effortless. We discuss how varying degrees of AI involvement influence learning, efficiency, and task load.`,
    },
    {
        id: "minglr",
        topic: ["research"],
