    ...
    return (
        <div className="extra-links">
            ...
            <a href={project.paper} target="_blank" rel="noreferrer">
                <i className="far fa-sticky-note" aria-hidden="true"></i> Paper
            </a>
            }
            {project.link &&
            ...
            <a href={project.slides} target="_blank" rel="noreferrer">
                <i className="far fa-window-maximize" aria-hidden="true"></i> Slides
            </a>
            }
            {project.poster &&
            <a href={project.poster} target="_blank" rel="noreferrer">
                <i className="far fa-window-maximize" aria-hidden="true"></i> Poster
            </a>
            }
            {project.code &&
